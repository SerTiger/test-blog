    ...
    <section class="auth">
        <div class="auth-wrap">
            ...
            <div class="auth-right">
                {!! Form::open(['route'=>'organization.store', 'id'=>'organization', 'class'=>"organization", 'files' => true]) !!}
                    <h2>Introducing Organization!</h2>
                    @auth
                        <p>Your wallet <span>{{ $CURRENT_USER->address_masked }}</span> must be associated with an organization to proceed forward.</p>
                    @endauth
...
<rect width="43.8308" height="44" fill="white" transform="translate(0.953857)"/>
                    ...
                    <div class="connector">
                        <div class="input-row">
                            <span>Discord</span>
                            <label>
                                <input type="text" name="contacts[discord]">
                            </label>
                        </div>
                        <div class="input-row">
                            <span>Telegram</span>
                            <label>
                                <input type="text" name="contacts[telegram]">
                            </label>
                        </div>
                    </div>
                    <button class="btn-blue" type="submit"><span>Create Organization</span></button>
                {!! Form::close() !!}
            </div>
        </div>
    </section>
