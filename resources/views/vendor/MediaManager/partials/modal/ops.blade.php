<section>
    ...
    <div v-if="isActiveModal('imageEditor_modal')"
        ...
        <div class="mm-animated fadeInDown __modal-content-wrapper">
            <image-editor route="{{ route('admin.media.uploadCropped') }}"
                :no-scroll="noScroll"
                :file="selectedFile"
                :trans="trans">
            </image-editor>
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('admin.media.uploadLink') }}" @submit.prevent="saveLinkForm($event)">
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('admin.media.new_folder') }}" @submit.prevent="NewFolderForm($event)">
                <section class="modal-card-body">
                    <input class="input" type="text"
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('admin.media.rename_file') }}" @submit.prevent="RenameFileForm($event)">
                <section class="modal-card-body">
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <form class="modal-card mm-animated fadeInDown"
            action="{{ route('admin.media.move_file') }}"
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('admin.media.delete_file') }}"
