...
<media-manager inline-template
    ...
    :routes="{{ json_encode([
        'files' => route('admin.media.get_files'),
        'lock' => route('admin.media.lock_file'),
        'visibility' => route('admin.media.change_vis'),
        'upload' => route('admin.media.upload'),
        'locked_list' => route('admin.media.locked_list')
    ]) }}"
                            ...
                            <div class="control">
                                <div class="field has-addons">
                                    <p class="control" v-if="!restrictModeIsOn">
                                        <global-search-btn
                                            route="{{ route('admin.media.global_search') }}"
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="t-val">
                                                        <form action="{{ route('admin.media.folder_download') }}"method="post" @submit.prevent="ZipDownload($event)">
                                                            {{ csrf_field() }}
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    {{-- zip --}}
                                                    <td class="t-val">
                                                        <form action="{{ route('admin.media.files_download') }}"
                                                            method="post"
